...
### Merging x, y and subject frames in one data frame and extract mean and std
...
extract_features  =  Merged_Data %>% select(subjects, Coding, contains("mean"), contains("std")) # extracting  mean and std
